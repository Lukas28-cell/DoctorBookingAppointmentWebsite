    ...
    <div>
      <div className='text-center text-2xl pt-10 text-gray-500'>
        ...
        <div className='my-10 flex flex-col justify-center md:flex-row gap-10 mb-28 text-sm'>
          ...
          <p className='text-gray-500'>432 Onibeson <br /> 36 ogudie barrack, Edo State, Nigerian </p>
          <p className='text-gray-500'>Tel: +2349025840337 <br /> Email: lukakoinaede@gmail.com</p>
